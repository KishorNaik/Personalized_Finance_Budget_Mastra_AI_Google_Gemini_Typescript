...
@sealed
@Service()
export class GetUserByIdentifierCacheService extends RedisStoreWrapper<
	IGetUserByIdentifierCacheServiceParameters,
	UserEntity
> {
	...
	protected async setCacheDataAsync(
		params: IGetUserByIdentifierCacheServiceParameters
