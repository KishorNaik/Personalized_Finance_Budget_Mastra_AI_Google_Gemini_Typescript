...
@sealed
@Service()
export class GetUserByEmailIdCacheService extends RedisStoreWrapper<IGetUserByEmailIdCacheServiceParameters,UserEntity> {
  ...
  protected async setCacheDataAsync(params: IGetUserByEmailIdCacheServiceParameters): Promise<Result<UserEntity, ResultError>> {
  ...
  protected async getRowVersionAsync(params: IGetUserByEmailIdCacheServiceParameters): Promise<Result<RowVersionNumber, ResultError>> {
    return await ExceptionsWrapper.tryCatchResultAsync(async ()=>{
