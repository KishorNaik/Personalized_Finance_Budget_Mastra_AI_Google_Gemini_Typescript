...
export interface IGetUserByIdentifierResponseMapperService
	extends IServiceHandlerAsync<UserEntity, GetUserByIdentifierResponseDto> {}

@sealed
@Service()
export class GetUserByIdentifierResponseMapperService
	implements IGetUserByIdentifierResponseMapperService
{
	public async handleAsync(
		...
		return await ExceptionsWrapper.tryCatchResultAsync(async () => {
			...
			// Map Response Dto
			const responseDto: GetUserByIdentifierResponseDto =
				new GetUserByIdentifierResponseDto();
