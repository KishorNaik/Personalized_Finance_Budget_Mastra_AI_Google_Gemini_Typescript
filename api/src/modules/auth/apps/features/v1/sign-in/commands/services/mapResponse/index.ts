...
export interface ISignInMapResponseService extends IServiceHandlerAsync<ISignInMapResponseServiceParameters,SignInResponseDto>{}

@sealed
@Service()
export class SignInMapResponseService implements ISignInMapResponseService {
  public async handleAsync(params: ISignInMapResponseServiceParameters): Promise<Result<SignInResponseDto, ResultError>> {
