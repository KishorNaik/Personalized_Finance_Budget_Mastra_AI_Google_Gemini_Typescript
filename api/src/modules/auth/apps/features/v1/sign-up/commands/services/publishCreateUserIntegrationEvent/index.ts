...
export interface IPublishCreateUserIntegrationEventService
	extends IServiceHandlerAsync<SignUpRequestDto, SignUpResponseDto> {}

@sealed
@Service()
export class PublishCreateUserIntegrationEventService
	implements IPublishCreateUserIntegrationEventService
{
	public async handleAsync(
		params: SignUpRequestDto
	): Promise<Result<SignUpResponseDto, ResultError>> {
